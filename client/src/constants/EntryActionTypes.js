...
export default {
  ...
  BOARD_DUPLICATE_HANDLE: `${PREFIX}/BOARD_DUPLICATE_HANDLE`,

  /* Folders */

  FOLDER_IN_CURRENT_PROJECT_CREATE: `${PREFIX}/FOLDER_IN_CURRENT_PROJECT_CREATE`,
  FOLDER_CREATE_HANDLE: `${PREFIX}/FOLDER_CREATE_HANDLE`,
  FOLDER_UPDATE: `${PREFIX}/FOLDER_UPDATE`,
  FOLDER_UPDATE_HANDLE: `${PREFIX}/FOLDER_UPDATE_HANDLE`,
  FOLDER_DELETE: `${PREFIX}/FOLDER_DELETE`,
