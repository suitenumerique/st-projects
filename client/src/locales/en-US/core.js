export default {
  ...
  translation: {
    common: {
      ...
      userAddedThisCardToList: '<0>{{user}}</0> created the card in the list <1>{{list}}</1>',
      userLeftNewCommentToCard: '<0>{{user}}</0> left a comment to <1>{{card}}</1>',
      userAssignedMember: '<0>{{user}}</0> assigned <1>{{member}}</1>',
      userAssignedYouToCard: '<0>{{user}}</0> assigned you to <1>{{card}}</1>',
      userChangedDueDateOfThisCard: '<0>{{user}}</0> changed the due date of the card',
      userChangedDueDateOfCard: '<0>{{user}}</0> changed the due date of <1>{{card}}</1>',
      userAddedAttachmentToThisCard: '<0>{{user}}</0> added an attachment to the card',
      ...
      userMovedThisCardFromListToList:
        '<0>{{user}}</0> moved the card from <1>{{fromList}}</1> to <2>{{toList}}</2>',
      username: 'Username',
